...
#import "rssRTHKAppDelegate.h"
#import "rssRTHKCurrentViewController.h"

NSString * const ManagedObjectContextSaveDidFailNotification = @"ManagedObjectContextSaveDidFailNotification";


@interface rssRTHKAppDelegate() <UIAlertViewDelegate>
...
@implementation rssRTHKAppDelegate
...
{
    UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Internal Error", nil) message:NSLocalizedString(@"Ther was a fatal error in the app and it cannot continue.\n\nPress OK to terminate the app. Sorry for the inconvenience.", nil) delegate:self cancelButtonTitle:NSLocalizedString(@"OK", nil) otherButtonTitles:nil];
    [alertView show];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    rssRTHKCurrentViewController *rssrthkcurrentviewcontroller = (rssRTHKCurrentViewController *) navigationcontroller.topViewController;
    rssrthkcurrentviewcontroller.managedObjectContext = self.managedObjectContext;
